...
const DATA = {
  satisfactory: {
    ...
    items: {
      ...
      'Wire':          { time: 2,  out: 4, in: { 'Copper Ingot': 1 } },
      ...
      'Supercomputer': { time: 32, out: 1, in: { 'Computer': 2, 'Circuit Board': 14, 'Wire': 28, 'Plastic': 28 } },
  ...
  factorio: {
    ...
    items: {
      ...
      'Processing Unit':     { time: 10,  out: 1, in: { 'Advanced Circuit': 2, 'Electronic Circuit': 20, 'Sulfuric Acid': 4 } },
