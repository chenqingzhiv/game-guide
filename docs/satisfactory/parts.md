...
6. Max of ~[77 Hard Drives](https://satisfactory.wiki.gg) exist on the map in a normal playthrough.
...
*Version: Satisfactory 1.0 (Update 9+). Recipes subject to change in future patches. Check the [Satisfactory Wiki](https://satisfactory.wiki.gg) for the latest numbers.*
