---
title: "Sons of the Forest — Complete Caves & Story Walkthrough Guide"
description: "Every cave location in Sons of the Forest mapped with loot, enemies, and story progression. Full walkthrough from crash site to all endings."
---

# 🌲 Sons of the Forest — Caves & Story Walkthrough
...
**General Strategy:**
- **Run past enemies** in early caves — many are narrow and fighting mutants in tight corridors is suicide
- **Place a tarp shelter** at the cave entrance so you can save and sleep outside
- **Mark cave entrances** on your GPS map with a custom marker
- **Bring a sled** (crafted from 4 sticks + 2 rope) for hauling loot
- **Caves don't respawn** — once cleared, they stay clear
...
4. **The Fingers Boss Fight:**
   - It has a long-range tongue grab that pulls you in — sprint sideways when you hear the tongue sound
   - Once grabbed, mash E to break free before it bites (bite kills in 2 hits)
   - Weakness: fire. Molotovs deal 4x damage
   - The arena has 4 pillars — kite around them
   - 3 shotgun blasts to the face stagger it for 5 seconds
5. **Final chamber** — the shovel is next to a skeleton. Behind it is a maintenance hatch that's the shortcut back to the surface (requires shovel to dig it out from outside, then it's open).
...
4. **The Twins Mutant:**
   - Two heads with separate health bars. Each head has its own attack
   - Head A: ranged bile spit (poison)
   - Head B: melee claw swipe
   - They share movement — if you run behind a pillar, they both circle
   - Kill Head A first (ranged is more dangerous), then Head B
   - Shotgun is ideal — 3 shells per head
5. **Final room** — the Rope Gun is on a weapon rack. A dead body next to it holds a note with a bunker passcode.
...
4. **The Demo Mutant:**
   - Slow, but deals massive AOE damage
   - Glows red when about to explode
   - When it dies, it explodes in a 15m radius — run away
   - Weakness: ranged weapons only. Do not melee.
5. **Escape:** After the Demo Mutant, grab Maintenance Keycard B and exit through the maintenance tunnel.
...
3. **The Final Mutant (Boss Fight):**
   - Huge, armored, with 3 attack phases
   - Phase 1: charge + claw swipe — dodge and shoot
   - Phase 2: spawns mini-mutants — use grenades
   - Phase 3: grows armor plates, becomes resistant to bullets — use C4 or the environmental hazards in the room (explosive barrels, gas vents)
   - Drops: Mutant Heart (used to craft the best creepy armor)
4. **The Artifact room:** a glowing orb on a pedestal. Taking it triggers a timer and the bunker begins self-destructing.
5. **Escape:** 5-minute timer. Run through the evacuation tunnel (marked with green lights). At the end is a zipline that takes you to the surface.
